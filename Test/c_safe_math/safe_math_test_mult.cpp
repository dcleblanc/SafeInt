...
{
	MultTestCase< std::uint64_t, std::int64_t> tests;
	MultTest<std::uint64_t, std::int64_t> test = tests.GetNext();

	while (!tests.Done())
	{
		uint64_t ret;

		bool result = check_mul_uint64_int64(test.x, test.y, &ret);
		...
		try
		{
			ret = safe_mul_uint64_int64(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
		...
		{
			assert(false);
			throw std::exception("Failure in mult_test_uint64_int64");
		}
...
void mult_test_uint64_int32()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_uint64_int32(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_uint64_int32");
		}

		bool actual;
		try
		{
			ret = safe_mul_uint64_int32(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
void mult_test_int64_uint64()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_int64_uint64(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_int64_uint64");
		}

		bool actual;
		try
		{
			ret = safe_mul_int64_uint64(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
{
	MultTestCase< std::int64_t, std::uint32_t> tests;
	MultTest<std::int64_t, std::uint32_t> test = tests.GetNext();

	while (!tests.Done())
	{
		int64_t ret;

		bool result = check_mul_int64_uint32(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_int64_uint32");
		}

		bool actual;
		try
		{
			ret = safe_mul_int64_uint32(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
void mult_test_int64_int64()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_int64_int64(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_int64_int32");
		}

		bool actual;
		try
		{
			ret = safe_mul_int64_int64(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
void mult_test_int64_int32()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_int64_int32(test.x, test.y, &ret);
		...
		try
		{
			ret = safe_mul_int64_int32(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
void mult_test_uint32_uint64()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_uint32_uint64(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_uint32_uint64");
		}

		bool actual;
		try
		{
			ret = safe_mul_uint32_uint64(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
void mult_test_uint32_uint32()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_uint32_uint32(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_uint32_uint32");
		}

		bool actual;
		try
		{
			ret = safe_mul_uint32_uint32(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
void mult_test_uint32_int64()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_uint32_int64(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_uint32_int64");
		}

		bool actual;
		try
		{
			ret = safe_mul_uint32_int64(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
...
void mult_test_uint32_int32()
{
	...
	while (!tests.Done())
	{
		...
		bool result = check_mul_uint32_int32(test.x, test.y, &ret);

		if (!!result != test.fExpected)
		{
			assert(false);
			throw std::exception("Failure in mult_test_uint32_int32");
		}

		bool actual;
		try
		{
			ret = safe_mul_uint32_int32(test.x, test.y);
			actual = true;
		}
		catch (...)
		{
