...
static const TestCase< std::uint64_t, std::int64_t, OpType::Div > uint64_int64[] =
{
   ...
   { 1,                     0x8000000000000000LL, true },
   { 2,                     0x8000000000000000LL, true },
   { 0x7fffffff,            0x8000000000000000LL, true },
   { 0x80000000,            0x8000000000000000LL, true },
   { 0xffffffff,            0x8000000000000000LL, true },
   { 0x100000000,           0x8000000000000000LL, true },
   { 0x200000000,           0x8000000000000000LL, true },
   { 0x7fffffffffffffff,    0x8000000000000000LL, true },
   { 0x8000000000000000,    0x8000000000000000LL, false },
   { 0xffffffffffffffff,    0x8000000000000000LL, false },
   ...
   { 0x100000000,           0xffffffffffffffffLL, false },
   { 0x200000000,           0xffffffffffffffffLL, false },
   { 0x7fffffffffffffff,    0xffffffffffffffffLL, false },
   { 0x8000000000000000,    0xffffffffffffffffLL, false },
   { 0xffffffffffffffff,    0xffffffffffffffffLL, false },
};
...
static const TestCase< std::int64_t, std::uint64_t, OpType::Div2 > int64_uint64_2[] =
{
   ...
   { 0x200000000,           0x100000000, true },
   { 0x7fffffffffffffff,    0x100000000, true },
   { 0x8000000000000000LL,  0x100000000, true },
   { 0xffffffffffffffffLL,  0x100000000, true },
   { 0,                     0x200000000, false },
   { 1,                     0x200000000, true },
   { 2,                     0x200000000, true },
   { 0x7fffffff,            0x200000000, true },
   ...
   { 0x200000000,           0x200000000, true },
   { 0x7fffffffffffffff,    0x200000000, true },
   { 0x8000000000000000LL,  0x200000000, true },
   { 0xffffffffffffffffLL,  0x200000000, true },
...
static const TestCase< std::int64_t, std::int64_t, OpType::Div > int64_int64[] =
{
   ...
   { (std::int64_t)0,                     0x8000000000000000LL, true },
   { (std::int64_t)1,                     0x8000000000000000LL, true },
   { (std::int64_t)2,                     0x8000000000000000LL, true },
   { (std::int64_t)0x7fffffff,            0x8000000000000000LL, true },
   { (std::int64_t)0x80000000,            0x8000000000000000LL, true },
   { (std::int64_t)0xffffffff,            0x8000000000000000LL, true },
   { (std::int64_t)0x100000000,           0x8000000000000000LL, true },
   { (std::int64_t)0x200000000,           0x8000000000000000LL, true },
   { (std::int64_t)0x7fffffffffffffff,    0x8000000000000000LL, true },
   { (std::int64_t)0x8000000000000000,    0x8000000000000000LL, true },
   { (std::int64_t)0xffffffffffffffff,    0x8000000000000000LL, true },
   { (std::int64_t)0,                     0xffffffffffffffffLL, true },
   { (std::int64_t)1,                     0xffffffffffffffffLL, true },
   { (std::int64_t)2,                     0xffffffffffffffffLL, true },
   { (std::int64_t)0x7fffffff,            0xffffffffffffffffLL, true },
   { (std::int64_t)0x80000000,            0xffffffffffffffffLL, true },
   { (std::int64_t)0xffffffff,            0xffffffffffffffffLL, true },
   { (std::int64_t)0x100000000,           0xffffffffffffffffLL, true },
   { (std::int64_t)0x200000000,           0xffffffffffffffffLL, true },
   { (std::int64_t)0x7fffffffffffffff,    0xffffffffffffffffLL, true },
   { (std::int64_t)0x8000000000000000,    0xffffffffffffffffLL, false },
   { (std::int64_t)0xffffffffffffffff,    0xffffffffffffffffLL, true },
};
...
static const TestCase< std::int32_t, std::int64_t, OpType::Div > int32_int64[] =
{
   ...
   { (std::int32_t)0,                     0x8000000000000000LL, true },
   { (std::int32_t)1,                     0x8000000000000000LL, true },
   { (std::int32_t)2,                     0x8000000000000000LL, true },
   { (std::int32_t)0x7fffffff,            0x8000000000000000LL, true },
   { (std::int32_t)0x80000000,            0x8000000000000000LL, true },
   { (std::int32_t)0xffffffff,            0x8000000000000000LL, true },
   { (std::int32_t)0,                     0xffffffffffffffffLL, true },
   { (std::int32_t)1,                     0xffffffffffffffffLL, true },
   { (std::int32_t)2,                     0xffffffffffffffffLL, true },
